                ...
                <fieldset>
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <label class="control-label" for="simple-input">UUDI</label><i class="bar"></i>
                    </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <label class="control-label" for="simple-input">ID SISTEMA EXTERNO</label><i class="bar"></i>
                    </div>
...
<fieldset>
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <label class="control-label" for="simple-input">URLJOIN</label><i class="bar"></i>
                    </div>
...
<fieldset>
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <label class="control-label" for="simple-input">URLSTART</label><i class="bar"></i>
                    </div>
...
<fieldset>
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <label class="control-label" for="simple-input">HOSTID</label><i class="bar"></i>
                    </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <label class="control-label" for="simple-input">CREATEDATE</label><i class="bar"></i>
                    </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <label class="control-label" for="simple-input">NOMBRE</label><i class="bar"></i>
                    </div>
